...
**두 분석 모두 각각 독립적으로 과제 요구사항을 전부 만족합니다** (아래 §8 체크리스트
...
시뮬레이션 분석은 데이터를 만드는 과정 자체가 여러 단계로 나뉘어 있어서, **반드시
...
## 7. GitHub Pages 켜는 방법 (대시보드 주소가 아직 안 열릴 때만)
